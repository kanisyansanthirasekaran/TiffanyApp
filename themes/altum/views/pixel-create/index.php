    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="" method="post" role="form">
                ...
                <div class="form-group">
                    <label for="type"><i class="fas fa-fw fa-adjust fa-sm mr-1"></i> <?= l('global.type') ?></label>
                ...
                <div class="form-group">
                    <label for="pixel"><i class="fas fa-fw fa-code fa-sm mr-1"></i> <?= l('pixels.input.pixel') ?></label>
