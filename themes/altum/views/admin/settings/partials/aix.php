...
<div>
    ...
    <div class="form-group">
        <label for="access_key"><?= l('admin_settings.aix.access_key') ?></label>
        <input id="access_key" type="text" name="access_key" class="form-control" value="<?= settings()->aix->access_key ?>" />
    </div>

    <div class="form-group">
        <label for="secret_access_key"><?= l('admin_settings.aix.secret_access_key') ?></label>
    ...
    <div class="form-group" id="provider_aws_s3">
        <label for="region"><?= l('admin_settings.aix.region') ?></label>
