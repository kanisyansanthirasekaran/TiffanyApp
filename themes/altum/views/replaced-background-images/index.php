...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><i class="fas fa-fw fa-xs fa-image-portrait mr-1"></i> <?= l('replaced_background_images.header') ?></h1>
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('replaced-background-image-create') ?>" class="btn btn-primary" data-toggle="tooltip" data-html="true" title="<?= get_plan_feature_limit_info($data->replaced_background_images_current_month, $this->user->plan_settings->replaced_background_images_per_month_limit) ?>">
                        <i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('replaced_background_images.create') ?>
                    </a>
                <?php endif ?>
            </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right filters-dropdown custom-scrollbar">
                        <div class="dropdown-header d-flex justify-content-between">
                            ...
                            <?php if(count($data->filters->get)): ?>
                                <a href="<?= url('replaced-background-images') ?>" class="text-muted"><?= l('global.filters.reset') ?></a>
                            <?php endif ?>
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center justify-content-center py-3">
                    <img src="<?= ASSETS_FULL_URL . 'images/no_rows.svg' ?>" class="col-10 col-md-7 col-lg-4 mb-3" alt="<?= l('replaced_background_images.no_data') ?>" />
                    <h2 class="h4 text-muted"><?= l('replaced_background_images.no_data') ?></h2>
                    <p class="text-muted"><?= l('replaced_background_images.no_data_help') ?></p>
                </div>
            </div>
        </div>
