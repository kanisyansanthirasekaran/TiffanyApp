...
<div class="container">
    ...
    <?php if(settings()->aix->documents_is_enabled): ?>
        <div class="my-4">
            <div class="row">
                <div class="col-12 col-lg-4 mb-4 position-relative text-truncate">
        ...
        <div class="my-4">
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="ml-3">
                    <a href="<?= url('document-create') ?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" data-html="true" title="<?= get_plan_feature_limit_info($data->documents_current_month, $this->user->plan_settings->documents_per_month_limit) ?>">
    ...
    <?php if(settings()->aix->images_is_enabled): ?>
        ...
        <div class="my-4">
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="ml-3">
                    <a href="<?= url('image-create') ?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" data-html="true" title="<?= get_plan_feature_limit_info($data->images_current_month, $this->user->plan_settings->images_per_month_limit) ?>">
    ...
    <?php if(settings()->aix->transcriptions_is_enabled): ?>
        ...
        <div class="my-4">
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="ml-3">
                    <a href="<?= url('transcription-create') ?>" class="btn btn-sm btn-outline-primary" data-toggle="tooltip" data-html="true" title="<?= get_plan_feature_limit_info($data->transcriptions_current_month, $this->user->plan_settings->transcriptions_per_month_limit) ?>">
