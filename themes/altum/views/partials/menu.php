                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <?php if(!\Altum\Teams::is_delegated()): ?>
                                    ...
                                    <?php if(settings()->aix->upscaled_images_is_enabled): ?>
                                        <a class="dropdown-item" href="<?= url('upscaled-images') ?>"><i class="fas fa-fw fa-sm fa-expand-arrows-alt mr-2"></i> <?= l('upscaled_images.menu') ?></a>
                                    <?php endif ?>

                                    <?php if(settings()->aix->removed_background_images_is_enabled): ?>
                                        <a class="dropdown-item" href="<?= url('removed-background-images') ?>"><i class="fas fa-fw fa-sm fa-image-portrait mr-2"></i> <?= l('removed_background_images.menu') ?></a>
                                    <?php endif ?>

                                    <?php if(settings()->aix->replaced_background_images_is_enabled): ?>
                                        <a class="dropdown-item" href="<?= url('replaced-background-images') ?>"><i class="fas fa-fw fa-sm fa-photo-film mr-2"></i> <?= l('replaced_background_images.menu') ?></a>
                                    <?php endif ?>
                                    ...
                                    <a class="dropdown-item" href="<?= url('projects') ?>"><i class="fas fa-fw fa-sm fa-project-diagram mr-2"></i> <?= l('projects.menu') ?></a>
