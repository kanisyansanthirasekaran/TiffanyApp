...
return [
    ...
    'Hiujin' => [
        ...
        'language_name' => 'Chinese (Cantonese)',
        'neural' => true,
        'standard' => false,
    ],
    ...
    'Inês/Ines' => [
        'gender' => 'female',
        'language_code' => 'pt-PT',
        'language_name' => 'Portuguese (European)',
        'neural' => true,
        'standard' => true,
    ],
    ...
    'Conchita' => [
        'gender' => 'female',
        'language_code' => 'es-ES',
        'language_name' => 'Spanish (European)',
        'neural' => false,
        'standard' => true,
    ],
