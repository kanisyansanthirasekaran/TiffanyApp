...
class AdminSettings extends Controller {
    ...
    public function aix() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['upscaled_images_is_enabled'] = (bool) $_POST['upscaled_images_is_enabled'];
            $_POST['removed_background_images_is_enabled'] = (bool) $_POST['removed_background_images_is_enabled'];
            $_POST['replaced_background_images_is_enabled'] = (bool) $_POST['replaced_background_images_is_enabled'];
            ...
            $_POST['syntheses_is_enabled'] = (bool) $_POST['syntheses_is_enabled'];
