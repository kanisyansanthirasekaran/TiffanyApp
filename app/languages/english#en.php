...
return [
    ...
    'index.header' => 'Level Up Your Content with <span class="text-gradient-primary" style="--gradient-one: var(--pink); --gradient-two: var(--indigo);">Ultimate</span> AI Assistant',
    'index.meta_description' => '',
    'index.meta_keywords' => '',
    'index.subheader' => 'Boost Your Workflow and Save Time with AI-Powered Content Creation! Get Your Innovations to the Cutting Edge Using Our First-Class AI Technology!',
    ...
    'index.widgets.one.subheader' => 'Find the Perfect Tool to Amplify Your Content Creation Experience!',
    'index.widgets.two.header' => 'Generate AI Content',
    'index.widgets.two.subheader' => '	Create Quickly and Effortlessly with Our Powerful AI Platform.',
    'index.widgets.three.header' => 'Check & polish',
    'index.widgets.three.subheader' => 'Utilize AI to Create High-Quality Content Effortlessly.',
    ...
    'index.chats.subheader' => 'Express yourself openly in conversation with AI.',
    'index.chats.messages.one' => 'Hi, can you please tell me, how does machine learning enhance medical diagnostics?',
    'index.chats.messages.two' => 'Machine learning algorithms analyze vast amounts of medical data to identify patterns and predict diseases with high accuracy. By learning from past cases, these systems assist doctors in making more informed diagnoses, leading to earlier detection and personalized treatment plans for patients, ultimately improving healthcare outcomes.',
    'index.chats.messages.three' => 'How does machine learning contribute to personalized healthcare through virtual assistants?',
    'index.chats.messages.four' => 'Machine learning algorithms, integrated into virtual assistants, analyze individual health data and user interactions to offer personalized healthcare recommendations and support. By leveraging natural language processing (NLP) capabilities, these assistants engage in meaningful conversations with users, providing tailored insights, reminders for medications, and lifestyle suggestions, thus empowering individuals to manage their health more effectively.',
    ...
    'index.testimonials.one.text' => 'As a social media influencer, time is everything. This AI platform has revolutionized my workflow, allowing me to produce high-quality content at lightning speed. It\'s an indispensable tool in my arsenal.',
    'index.testimonials.one.name' => 'Emily',
    'index.testimonials.one.attribute' => 'Social Media Influencer',
    'index.testimonials.two.text' => 'I\'ve tried numerous content creation tools, but none compare to this AI platform. Its intuitive interface and advanced algorithms make crafting compelling content a breeze. My followers have noticed the difference!',
    'index.testimonials.two.name' => 'Jake',
    'index.testimonials.two.attribute' => 'Content Creator',
    'index.testimonials.three.text' => 'Being a content creator requires constant innovation. This AI platform not only streamlines my content creation process but also sparks fresh ideas with its intelligent suggestions. It\'s like having a brainstorming partner that never sleeps.',
    'index.testimonials.three.name' => 'Max',
    'index.testimonials.three.attribute' => 'Content Creator',

    'index.faq.header' => '%1$sAnswers%2$s for your common %1$squestions%2$s',
    'index.faq.one.question' => 'Is Tiffany App suitable for beginners?',
    'index.faq.one.answer' => 'Absolutely, Tiffany App is designed to be user-friendly, catering to individuals with varying levels of expertise.',
    'index.faq.two.question' => 'What makes Tiffany App stand out in the crowded market of content creation tools?',
    'index.faq.two.answer' => 'Tiffany App\'s commitment to innovation and user satisfaction sets it apart, with tailored features and superior user experience.',
    'index.faq.three.question' => 'Can Tiffany App help content creators overcome creative blocks and generate fresh ideas?',
    'index.faq.three.answer' => 'Absolutely! Tiffany App\'s AI-powered brainstorming feature provides creators with personalized prompts and suggestions to inspire creativity and overcome writer\'s block. By tapping into a vast repository of data and trends, Tiffany App ensures that creators always have access to fresh and relevant content ideas.',
    'index.faq.four.question' => 'How has Tiffany App transformed the productivity and success of content creators?',
    'index.faq.four.answer' => 'Tiffany App has had a profound impact on the productivity and success of content creators worldwide. By streamlining workflows, automating repetitive tasks, and offering valuable insights into audience preferences, Tiffany App enables creators to produce higher-quality content in less time, ultimately driving increased engagement and growth.',

    'index.cta.header' => 'Ready to unleash your creativity?',
    'index.cta.subheader' => 'Sign in now to unlock limitless possibilities with our powerful AI generative tools. Let\'s create together!',
